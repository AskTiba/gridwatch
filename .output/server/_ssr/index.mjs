...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BC3c8E5f.mjs");
...
const manifest = {
  "02cbe41f5c1d7a560a4cfba9114ec7b322e924ddd23f081912168033518cd8f3": {
    functionName: "getIncidentById_createServerFn_handler",
    importer: () => import("./incidents-De4Gb9tq.mjs")
  },
  "139461d16f5a6a8bee8a86a56c8f4162cf2e1a03c99cf27149f5e9602a6befbb": {
    functionName: "createIncidentReport_createServerFn_handler",
    importer: () => import("./incidents-De4Gb9tq.mjs")
  },
  "2181be763741d7728f6fc1bfd6bfac33d2beec5ab22173aa4385a4523925c7f2": {
    functionName: "unsubscribeFromPush_createServerFn_handler",
    importer: () => import("./notifications-BfxGS4rL.mjs")
  },
  "2bbc8df4e60ebed917af9e6065df8b65d441a49755d61c521bae48bcbd3a6334": {
    functionName: "getZoneOutages_createServerFn_handler",
    importer: () => import("./zones-Duz9OZ7z.mjs")
  },
  "4042e41827982b57fae90695d7b5fe1931e6010b78379f3b5337a775a16ed2f4": {
    functionName: "subscribeToPush_createServerFn_handler",
    importer: () => import("./notifications-BfxGS4rL.mjs")
  },
  "4b4b4e86078dbaec32896196c374fed4f37d4db9f0b3684dac0c05b1033f1eab": {
    functionName: "getZoneById_createServerFn_handler",
    importer: () => import("./zones-Duz9OZ7z.mjs")
  },
  "4c8661f3dcaa465cdfbada0002afa599af4d2fc3a6db7ea3d1c13dfa2e60c395": {
    functionName: "getIncidents_createServerFn_handler",
    importer: () => import("./incidents-De4Gb9tq.mjs")
  },
  "64cfd77e03214800d3c6fda1ca70318d99ee1cc4dbaf02000ae64c448df9fefc": {
    functionName: "sendZoneNotification_createServerFn_handler",
    importer: () => import("./notifications-BfxGS4rL.mjs")
  },
  "82b59b3823b87568df34a504b1a95b25b1662489e19a70d2279348a9f3feba28": {
    functionName: "getVapidPublicKey_createServerFn_handler",
    importer: () => import("./notifications-BfxGS4rL.mjs")
  },
  "c476bfc769d26f0a412c12d4a446bc36dfee1ed7e1a06c8d9b9d980f8e01ec61": {
    functionName: "upvoteIncident_createServerFn_handler",
    importer: () => import("./incidents-De4Gb9tq.mjs")
  },
  "cd9f884e84fd847fa05ca938f18787c99a92b2d32446db736d2fb6a6ca00fd58": {
    functionName: "getZones_createServerFn_handler",
    importer: () => import("./zones-Duz9OZ7z.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-GetVqPza.mjs").then((n) => n.r),
...
async function handleRedirectResponse(response, request, getRouter, signal) {
  ...
  signal.throwIfAborted();
  const redirect2 = router.resolveRedirect(ssrResponse.response);
  if (request.headers.get("x-tsr-serverFn") === "true") return waitForRequest(replaceSsrResponse(ssrResponse, Response.json({
    ...ssrResponse.response.options,
    isSerializedRedirect: true
  }, { headers: ssrResponse.response.headers }), "redirect response replaced"), signal);
